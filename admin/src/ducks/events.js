...
export default function reducer(state = new ReducerRecord(), action) {
  ...
  switch (type) {
    ...
    case FETCH_LAZY_SUCCESS:
      const loaded = Object.keys(payload).length < LIMIT
...
export const lastIdSelector = createSelector(entitiesSelector, (entities) =>
  entities.keySeq().last()
)
...
export function* fetchLazySaga() {
  ...
  const lastId = yield select(lastIdSelector)
